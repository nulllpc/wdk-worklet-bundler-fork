...
export const DEFAULT_BUNDLE_PATH = `./${DEFAULT_OUTPUT_DIR}/${DEFAULT_BUNDLE_FILENAME}`;
export const DEFAULT_TYPES_PATH = `./${DEFAULT_OUTPUT_DIR}/${DEFAULT_TYPES_FILENAME}`;

export const DEFAULT_BUNDLE_BUILD_HOSTS = ['ios-arm64', 'ios-arm64-simulator', 'android-arm64', 'android-arm', 'android-arm64', 'android-ia32', 'android-x64'];